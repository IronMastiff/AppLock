...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainViewHolder> {
     ...
     * 初始化数据
     */
    private void initData( TextView textViewName, CheckBox switchCompat, ImageView mAppIcon, CommLockInfo lockInfo ){
        textViewName.setText( packageManager.getApplicationLabel( lockInfo.getAppInfo() ) );
